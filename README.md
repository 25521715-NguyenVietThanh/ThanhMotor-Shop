...
Tạo mã QR   qrcode
Xuất PDF    ReportLab
Frontend    Bootstrap 5.3, Font Awesome 6Template EngineDjango Templates
...
⚙️ Cài đặt và chạy
1. Clone repository
bashgit clone  https://github.com/25521715-NguyenVietThanh/ThanhMotor-Shop.git
cd Project_BanXe
2. Tạo môi trường ảo
...
Đăng nhập pythonanywhere.com
Mở Bash console, clone repo:

bash   git clone https://github.com/25521715-NguyenVietThanh/ThanhMotor-Shop.git

Cài thư viện và cấu hình Web app theo hướng dẫn của PythonAnywhere
Đặt biến môi trường DJANGO_SECRET_KEY trong mục Environment variables
